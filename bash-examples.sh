...
# Filename with extension: `LICENSE.txt`
# Filename without extension: `LICENSE`
...
split1 '  -e  \n  ' '  *  '
# $*= -e \n bash-examples.sh example examples-generator.sh example.txt filename with spaces.txt LICENSE.txt Makefile readme.rst todo.md
# 
# \n
# bash-examples.sh
# example
...
# All arguments $*   = `-e \n {a..z} !! $((2+2)) bash-examples.sh example examples-generator.sh example.txt filename with spaces.txt LICENSE.txt Makefile readme.rst todo.md ~ $HOME \ `pwd` $(pwd) . .. ... ..... `
# All arguments $@   = `-e \n {a..z} !! $((2+2)) bash-examples.sh example examples-generator.sh example.txt filename with spaces.txt LICENSE.txt Makefile readme.rst todo.md ~ $HOME \ `pwd` $(pwd) . .. ... ..... `
# All arguments "$*" = `-e \n {a..z} !! $((2+2)) * ~ $HOME \ `pwd` $(pwd)    . .. ... .....    `
# All arguments "$@" = `-e \n {a..z} !! $((2+2)) * ~ $HOME \ `pwd` $(pwd)    . .. ... .....    `
